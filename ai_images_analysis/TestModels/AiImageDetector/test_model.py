...
pipe = pipeline("image-classification", model="umm-maybe/AI-image-detector", device=device)
...
df.to_csv('csv/ResultsAiDetectorFake.csv', index=False)
# df.to_csv('csv/ResultsAiDetectorReal.csv', index=False)
