...
df = pd.read_csv('../../AiImageDetector2/csv/ResultsAiDetector2Fake.csv')
...
plt.title('Percentuale di immagini reali con probabilità di essere sintetiche (SDXL Detector)', fontsize=16)
