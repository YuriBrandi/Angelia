...
df = pd.read_csv('../../CNNDetection/csv/ResultsCNNReal.csv')
...
plt.title('Percentuale di immagini reali con probabilità di essere sintetiche (CNNDetection)', fontsize=16)
